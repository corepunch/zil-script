...
return {
	...
	commands = {
		...
		{input="drop plaque",description="Drop brass plaque (no longer needed)"},
		...
		{input="drop key",description="Drop brass key (no longer needed)"},
		...
		{input="drop scalpel",description="Drop scalpel (no longer needed)"},
		...
		{input="drop records",description="Drop medical records (no longer needed)"},
		...
		{input="drop notebook",description="Drop soggy notebook (no longer needed)"},
		...
		{input="drop jacket",description="Drop straitjacket (optional item, not needed)"},
		...
		{input="drop logbook",description="Drop observation logbook (no longer needed)"},
		...
		{input="take photograph",inventory="PHOTOGRAPH",description="Take staff photo from 1950"},
		{input="examine photograph",text="1950",description="See the sanitarium staff"},
		{input="drop photograph",description="Drop staff photograph (no longer needed)"},
		{input="west",here="CAFETERIA",description="Enter Cafeteria"},
		{input="examine counter",text="bell",description="Old service area"},
		{input="take bell",inventory="BELL",description="Take service bell (optional)"},
		{input="drop bell",description="Drop service bell (optional item, not needed)"},
