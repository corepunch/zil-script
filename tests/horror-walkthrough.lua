...
return {
	...
	commands = {
		...
		{input="take flashlight",take="WORKING-FLASHLIGHT",description="Take the working flashlight"},
		...
		{input="drop key",lose="BRASS-KEY",description="Drop brass key (no longer needed)"},
		{input="take ledger",take="PATIENT-LEDGER",description="Take patient ledger from drawer"},
		{input="read ledger",text="patient 237",description="Learn about Patient 237 and Dr. Mordecai"},
		{input="drop ledger",lose="PATIENT-LEDGER",description="Free hands by dropping ledger"},
		...
		{input="unlock door",global="CHAPEL-UNLOCKED",description="Use chapel key to unlock final area"},
