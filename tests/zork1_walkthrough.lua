...
return {
	...
	commands = {
		...
		{ input="walk southeast", text="Engravings Cave" },
		...
		{ input="walk northeast", text="Reservoir South" },
		...
		{ input="walk northeast", text="Coal Mine" },
		{ input="walk southeast", text="Coal Mine" },
		...
		{ input="walk northeast", text="Sandy Cave" },
		...
		{ input="walk east", text="Maze" },
		{ input="walk south", text="Maze" },
		{ input="walk southeast", text="Cyclops Room" },
		...
		{ input="walk northeast", text="Grating Room" },
