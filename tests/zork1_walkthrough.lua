...
return {
	...
	commands = {
		...
		{ input="test:move THIEF CYCLOPS-ROOM", description="Move thief to Cyclops Room for testing" },
		...
		{ input="test:move THIEF TREASURE-ROOM", description="Move thief to Treasure Room for encounter" },
		{ input="walk up", here="TREASURE-ROOM", description="Enter Treasure Room" },
		...
		{ input="kill thief with knife", description="The thief is disarmed by a subtle feint past his guard." },
		{ input="kill thief with knife", description="You dodge as the thief comes in low." },
		{ input="kill thief with knife", description="It's curtains for the thief as your nasty knife removes his head." },
		{ input="take all", text="stiletto: Taken." },
		{ input="drop stiletto", text="Dropped." },
		{ input="drop torch", description="Drop torch if present" },
