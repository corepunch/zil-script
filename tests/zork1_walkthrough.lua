...
return {
	...
	commands = {
		...
		{ input="kill thief with knife", description="Attack thief (1)" },
		{ input="kill thief with knife", description="Attack thief (2)" },
		{ input="kill thief with knife", description="Attack thief (3)" },
		{ input="take all", text="stiletto: Taken." },
		{ input="drop stiletto", text="Dropped." },
		{ input="take chalice", description="Take or already have chalice" },
