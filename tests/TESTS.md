...
Test files can use special assertion commands to verify game state. These are handled by `zil-script/bootstrap.lua`.
...
- **Compiler modules**: See `zil-script/compiler/README.md`
